document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateRankText(score) {
        if (score < 1000) {
            rankText.innerHTML = 'Bronze League 🥉'; // اضافه کردن ایموجی برنز
            ...
            rankText.innerHTML = 'Silver League 🥈'; // اضافه کردن ایموجی نقره
            ...
            rankText.innerHTML = 'Golden League 🥇'; // اضافه کردن ایموجی طلا
            ...
            rankText.innerHTML = 'diamond league 💎'; // اضافه کردن ایموجی الماس
